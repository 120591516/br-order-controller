...
public class OrgExamItemTypeController {
    ...
    */
    ...
    public JSONObject getAllOrgExamItemType() {
        ...
        try {
            ...
            Map<String, Object> operationList = brOperationService.getOperationByRole(rolesList, "orgExamItemType");
    ...
    */
    ...
    @ResponseBody
    public JSONObject updateOrgExamItemType(OrganizationExamItemType orgExamItemType) {
        JSONObject message = new JSONObject();
        try {
