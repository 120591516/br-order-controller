	 ...
	 /**
		...
		*/
		...
		public JSONObject deleteOrgExamItemUser(
				@ApiParam(required = true, name = "organizationUserId", value = "organizationUserId,医生id") String organizationUserId,
				@ApiParam(required = true, name = "examItemUserId", value = "examItemUserId,检查项id") String organizationExamItemId
				){
			JSONObject message = new JSONObject();
			try {
				OrganizationExamItemUser organizationExamItemUser = orgExamItemUserService.selectOrgExamItemUserByParam(organizationUserId, organizationExamItemId);
				String organizationExamItemUserId = organizationExamItemUser.getOrganizationExamItemUserId();
				int i = orgExamItemUserService.deleteOrgExamItemUser(organizationExamItemUserId);
				message.put("data", i);
				return InterfaceResultUtil.getReturnMapSuccess(message);
