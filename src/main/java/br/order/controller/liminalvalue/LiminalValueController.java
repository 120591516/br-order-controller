...
* @version V1.0   
*/
package br.order.controller.liminalvalue;
...
public class LiminalValueController {
    ...
    * @throws
    ...
    @ResponseBody
    public JSONObject getOrganizationBranchLimitPeople(@ApiParam(required = true, name = "page", value = "page,当前页") @RequestParam(value = "page", defaultValue = "1", required = true) Integer page,
        ...
        try {
            if (organizationBranchvo != null && organizationBranchvo.getBranchName() != null) {
                organizationBranchvo.setBranchName((TransCoding.encodeStr(organizationBranchvo.getBranchName())));
            }
            ...
            Map<String, Object> operationList = brOperationService.getOperationByRole(rolesList, "liminalValue");
    ...
    * @throws
    ...
    @ResponseBody
    public JSONObject updateOrgBranchLimitPeople(@ApiParam(name = "branchId", value = "门店id", required = true) String branchId,
            @ApiParam(name = "limitPeople", value = "限制人数", required = true) Integer limitPeople, @ApiParam(name = "warnPeople", value = "警告人数", required = true) Integer warnPeople) {
        JSONObject message = new JSONObject();
        try {
    ...
    * @throws
    ...
    @ResponseBody
    public JSONObject getOrgExamSuiteLimitPeople(@ApiParam(required = true, name = "page", value = "page,当前页") @RequestParam(value = "page", defaultValue = "1", required = true) Integer page,
            @ApiParam(required = true, name = "rows", value = "rows,每页显示条数") @RequestParam(value = "rows", defaultValue = "10", required = true) Integer rows,
    ...
    * @throws
    ...
    @ResponseBody
    public JSONObject updateOrgExamSuiteLimitPeople(@ApiParam(name = "suiteId", value = "套餐id", required = true) String suiteId,
            @ApiParam(name = "limitPeople", value = "限制人数", required = true) Integer limitPeople, @ApiParam(name = "warnPeople", value = "警告人数", required = true) Integer warnPeople) {
        JSONObject message = new JSONObject();
        try {
