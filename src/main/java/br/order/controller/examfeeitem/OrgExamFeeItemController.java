package br.order.controller.examfeeitem;
...
public class OrgExamFeeItemController {
    ...
    /** 
    * @Title: getOrgExamFeeItemByPage 
    * @Description: TODO(分页获取收费项列表) 
    * @param page 页数
    * @param rows 每页显示行数
    * @param orgExamFeeItemQu 分页条件查询对象
    * @return JSONObject    
    * @throws 
    */

    @ApiOperation(value = "分页收费项列表", httpMethod = "GET", response = JSONObject.class, notes = "分页获取体检列表")
    @RequestMapping("/getOrgExamFeeItemByPage")
    @ResponseBody
    public JSONObject getOrgExamFeeItemByPage(@ApiParam(required = true, name = "page", value = "page,当前页") @RequestParam(value = "page", defaultValue = "1", required = true) Integer page,
        ...
        try {
            ...
            PageInfo<OrgExamFeeItemVo> pageInfo = orgExamFeeItemService.getOrgExamItemByPage(orgExamFeeItemQu, page, rows);
            List<BrRoleVo> rolesList = commonController.getUserBySession().getRoles();
            Map<String, Object> operationList = brOperationService.getOperationByRole(rolesList, "orgFeeItem");
    ...
    /** 
    * @Title: insertOrgExamFeeItem 
    * @Description: TODO(新增收费项) 
    * @param organizationExamFeeItem 收费项对象
    * @return JSONObject    
    * @throws 
    */
    ...
    @ResponseBody
    public JSONObject insertOrgExamFeeItem(@ApiParam(required = true, name = "insertOrgExamFeeItem", value = "insertOrgExamFeeItem,新增收费项对象") OrganizationExamFeeItem organizationExamFeeItem) {
        JSONObject message = new JSONObject();
        try {
    ...
    /** 
    * @Title: getOrgExamFeeItemById 
    * @Description: TODO(根据收费项id查询收费项所有信息) 
    * @param id 收费项id
    * @return JSONObject    
    * @throws 
    */
    ...
    /** 
    * @Title: deleteOrgExamFeeItemById 
    * @Description: TODO(删除收费项信息) 
    * @param id 收费项id
    * @return JSONObject    
    * @throws 
    */
    ...
    /** 
    * @Title: updateOrgExamFeeItem 
    * @Description: TODO(修改收费项信息) 
    * @param organizationExamFeeItem 收费项对象
    * @return JSONObject    
    * @throws 
    */
    ...
    @ResponseBody
    public JSONObject updateOrgExamFeeItem(@ApiParam(required = true, name = "OrganizationExamFeeItem", value = "OrganizationExamFeeItem,修改收费项对象") OrganizationExamFeeItem organizationExamFeeItem) {
        JSONObject message = new JSONObject();
        try {
    ...
    /** 
    * @Title:  
    * @Description: TODO(根据套餐id查询收费项信息) 
    * @param orgExamSuiteId 套餐对象
    * @return JSONObject    
    * @throws 
    */
    ...
    @ResponseBody
    public JSONObject getOrgExamFeeItemBySId(@ApiParam(required = true, name = "page", value = "page,当前页") @RequestParam(value = "page", defaultValue = "1", required = true) Integer page,
            @ApiParam(required = true, name = "rows", value = "rows,每页显示条数") @RequestParam(value = "rows", defaultValue = "10", required = true) Integer rows,
        ...
        try {
            if (orgExamSuiteId != null) {
                PageInfo<OrgExamFeeItemVo> pageInfo = orgExamFeeItemSuiteService.getOrgExamFeeItemBySId(orgId, orgExamSuiteId, page, rows);
                message.put("data", pageInfo);
                return InterfaceResultUtil.getReturnMapSuccess(message);
            }
        }
